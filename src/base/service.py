...
def get_path_upload_cover_album(instance, file):
    ...
    return f'albam/user_{instance.user.id}/{file}'
...
def validate_size_image(file_obj):
    ...
    if file_obj.size > megabyte_limit * 1024:
        raise ValidationError(f"Максимальный размер файла превышен {megabyte_limit}")
