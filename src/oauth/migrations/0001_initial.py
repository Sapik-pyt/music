    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(blank=True, null=True, upload_to=src.base.service.get_path_upload_avatar, validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['jpg']), src.base.service.validate_size_image])),
            ],
        ),
        migrations.CreateModel(
            name='SocialLink',
